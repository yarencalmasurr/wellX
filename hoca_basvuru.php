...
<head>
    ...
    <title>Eğitmen Başvurusu | WellX Elite</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        :root { --neon-blue: #00d2ff; --dark-bg: #0f172a; --card-glass: rgba(30, 41, 59, 0.7); --text-light: #f1f5f9; }
        ...
        .apply-container { position: relative; z-index: 10; width: 100%; max-width: 600px; padding: 50px; margin: 40px 20px; background: var(--card-glass); backdrop-filter: blur(20px); border-radius: 24px; border: 1px solid rgba(0, 210, 255, 0.2); box-shadow: 0 25px 60px rgba(0, 0, 0, 0.4); }
        .apply-container h2 { color: var(--neon-blue); font-weight: 800; font-size: 32px; margin-bottom: 10px; text-transform: uppercase; letter-spacing: 1px; }
        .apply-container p { color: #94a3b8; font-size: 14px; margin-bottom: 35px; }
        .form-group { text-align: left; margin-bottom: 25px; }
        label { display: block; font-size: 12px; font-weight: 700; color: var(--neon-blue); margin-bottom: 8px; text-transform: uppercase; letter-spacing: 1px; }
        .input-wrapper { position: relative; }
        .input-wrapper i { position: absolute; left: 18px; top: 18px; color: var(--neon-blue); font-size: 16px; }
        ...
        input:focus, textarea:focus { border-color: var(--neon-blue); background: rgba(15, 23, 42, 0.9); box-shadow: 0 0 15px rgba(0, 210, 255, 0.2); }
        .btn-send { width: 100%; padding: 18px; border-radius: 12px; border: none; background: linear-gradient(135deg, #00d2ff 0%, #3a7bd5 100%); color: white; font-size: 16px; font-weight: 700; cursor: pointer; transition: 0.3s; text-transform: uppercase; letter-spacing: 2px; box-shadow: 0 10px 20px rgba(0, 210, 255, 0.2); margin-top: 15px; }
        .btn-send:hover { transform: translateY(-3px); box-shadow: 0 15px 30px rgba(0, 210, 255, 0.4); filter: brightness(1.1); }
        ...
        .apply-container::before { content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 4px; background: linear-gradient(90deg, transparent, var(--neon-blue), transparent); border-radius: 24px 24px 0 0; }
    </style>
</head>
<body>
...
<script>
    particlesJS("particles-js", {
        "particles": { "number": { "value": 60 }, "color": { "value": "#00d2ff" }, "opacity": { "value": 0.3 }, "size": { "value": 2 }, "line_linked": { "enable": true, "color": "#00d2ff", "opacity": 0.2 }, "move": { "enable": true, "speed": 2 } }
    });
</script>
</body>
</html>