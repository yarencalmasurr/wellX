...
<head>
    <meta charset="UTF-8">
    <title>Ekiplerimize Katılın - Diyetisyen</title>
    ...
    <style>
        ...
        .badge { background: #e8fdf5; color: #2ecc71; padding: 6px 18px; border-radius: 20px; font-size: 11px; font-weight: 600; text-transform: uppercase; display: inline-block; margin-bottom: 10px; }
        ...
        input:focus, textarea:focus { outline: none; border-color: #2ecc71; background: #fff; }
...
<body>
    <div class="form-card">
        <center><span class="badge">🍎 DİYETİSYEN PANELİ</span></center>
        <h1>Ekiplerimize Katılın</h1>
        
        <form action="islem.php?is=uzman_kayit" method="POST" enctype="multipart/form-data">
            ...
            <label>Uzmanlık / Beslenme Ekolü</label>
            <input type="text" name="uzmanlik" placeholder="Örn: Ketojenik, Fonksiyonel Tıp, Klinik" required>
            
            <label>Tecrübe / Özgeçmiş</label>
            <textarea name="tecrube" placeholder="Daha önceki danışmanlık tecrübelerinizden bahsedin..." rows="3"></textarea>
