...
<head>
    ...
    <title>Diyetisyen Başvurusu | WellX </title>
    ...
    <style>
        :root {
            --neon-teal: #2dd4bf; /* Diyetisyen için hafif turkuaz/yeşil neon */
            --dark-bg: #0f172a;
        ...
        label { 
            ...
            color: var(--neon-teal); margin-bottom: 8px; 
        ...
        .input-wrapper i {
            ...
            color: var(--neon-teal); font-size: 16px;
        }
...
<div class="apply-container">
    <h2>BESLENME UZMANI 🍎</h2>
    <p>Beslenme ekolünüzü WellX  üyeleriyle paylaşın.</p>
